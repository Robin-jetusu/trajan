...
// DefaultSeverities maps each vulnerability type to its default severity
var DefaultSeverities = map[VulnerabilityType]Severity{
	VulnActionsInjection:            SeverityHigh,
	VulnPwnRequest:                  SeverityHigh,
	VulnReviewInjection:             SeverityHigh,
	VulnTOCTOU:                      SeverityHigh,
	VulnArtifactPoison:              SeverityHigh,
	VulnCachePoisoning:              SeverityHigh,
	VulnSelfHostedRunner:            SeverityHigh,
	VulnSelfHostedAgent:             SeverityHigh,
	VulnUnpinnedAction:              SeverityHigh,
	VulnIncludeInjection:            SeverityHigh,
	VulnMergeRequestUnsafeCheckout:  SeverityCritical,
	VulnMergeRequestSecretsExposure: SeverityHigh,
	VulnPullRequestSecretsExposure:  SeverityMedium,
	VulnTokenExposure:               SeverityHigh,
	VulnExcessivePermissions:        SeverityHigh,
	// Zizmor High severity
	VulnOverprovisionedSecrets:  SeverityHigh,
	VulnGitHubEnv:               SeverityHigh,
	VulnHardcodedContainerCreds: SeverityHigh,
	VulnArtipacked:              SeverityHigh,
	VulnKnownVulnerableActions:  SeverityHigh,
	VulnImpostorCommit:          SeverityHigh,
	// Zizmor Medium severity
	VulnUnsoundContains:    SeverityMedium,
	VulnUnsoundCondition:   SeverityMedium,
	VulnUnredactedSecrets:  SeverityMedium,
	VulnSecretsInherit:     SeverityMedium,
	VulnRefVersionMismatch: SeverityMedium,
	VulnRefConfusion:       SeverityMedium,
	VulnBotConditions:      SeverityMedium,
	VulnArchivedUses:       SeverityMedium,
	// Zizmor Low severity
	VulnAnonymousDefinition:     SeverityLow,
	VulnUseTrustedPublishing:    SeverityLow,
	VulnUnpinnedImages:          SeverityLow,
	VulnUndocumentedPermissions: SeverityLow,
	VulnStaleActionRefs:         SeverityLow,
	VulnObfuscation:             SeverityLow,
	VulnMisfeature:              SeverityLow,
	VulnInsecureCommands:        SeverityLow,
	VulnForbiddenUses:           SeverityLow,
	VulnConcurrencyLimits:       SeverityLow,
	VulnAITokenExfiltration:     SeverityHigh,
	VulnAICodeInjection:         SeverityHigh,
	VulnAIWorkflowSabotage:      SeverityHigh,
	VulnAIMCPAbuse:              SeverityHigh,
	VulnAIPrivilegeEscalation:   SeverityHigh,
	VulnAISupplyChainPoisoning:  SeverityHigh,
	// New detection severities
	VulnSecretScopeRisk:          SeverityLow,
	VulnEnvironmentBypass:        SeverityLow,
	VulnCompositeActionRisk:      SeverityHigh,
	VulnDynamicTemplateInjection: SeverityHigh,
	VulnReusableWorkflowRisk:     SeverityMedium,
	// Jenkins-specific detection severities
	VulnJenkinsScriptConsole:          SeverityCritical,
	VulnJenkinsAnonymousAccess:        SeverityHigh,
	VulnJenkinsCSRFDisabled:           SeverityMedium,
	VulnScriptInjection:               SeverityHigh,
	VulnTriggerExploitation:           SeverityHigh,
	VulnExcessiveJobPermissions:       SeverityLow,
	VulnServiceConnectionHijacking:    SeverityHigh,
	VulnOverexposedServiceConnections: SeverityMedium,
}

// GetDefaultSeverity returns the default severity for a vulnerability type
func GetDefaultSeverity(vt VulnerabilityType) Severity {
	if s, ok := DefaultSeverities[vt]; ok {
		return s
	}
	return SeverityHigh
}
